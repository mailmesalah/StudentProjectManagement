...
<html>
    ...
    <body>
        ...
        <%
                    ...
                    int i = stmt.executeUpdate("Update SPMProfessors Set Status='D' Where SPMProfessors.ProfessorCode=" + professorCode + ";");

                    if (i > 0) {
                        session.setAttribute("Info", "Successfully Disabled !");
                        session.setAttribute("Error", "");
                        response.sendRedirect("ManageProfessors.jsp");
                    } else {
                        session.setAttribute("Error", "Disable Unsuccessfull !");
