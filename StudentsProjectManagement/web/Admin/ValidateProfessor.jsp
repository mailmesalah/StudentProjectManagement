...
<html>
    <head>
        ...
        <title>Validate Professor</title>
    </head>
    <body>
        <h1>Validate Professor!</h1><hr>
        <%
        ...
        <%
                    ...
                    int i = stmt.executeUpdate("Update SPMProfessors Set Status='V' Where SPMProfessors.ProfessorCode=" + professorCode + ";");
