    ...
    <body>
        ...
        <%        
            ...
            try {
                ...
                File dir = new File(application.getInitParameter("CurrentProjectAbstract") + "\\" + groupCode + ".doc");
                ...
                int i = stmt.executeUpdate("Update SPMCurrentProject Set Status='AS' Where (GroupCode=" + groupCode + ");");                
                stmt.close();
