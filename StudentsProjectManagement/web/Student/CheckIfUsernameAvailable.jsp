...
<html>
    <head>
        ...
        <title>Checks Student Username if available for register</title>
    </head>
    <body>
        <h1>Checks Username!</h1>
        <%
        ...
        <table border="1">
            <form  name="form" method="post" action="CheckIfUsernameAvailable.jsp">
                <tr><td>Username</td><td>:</td><td><input id="Username" type="text" name="username" value="" size="30"></td><td><input type="submit" name="check" value="Check for Availability"></td></tr>
            </form>
        </table>
    </body>
</html>
