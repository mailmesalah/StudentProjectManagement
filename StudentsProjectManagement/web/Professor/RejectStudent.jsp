...
<html>
    <head>
        ...
        <title>Disable Student</title>
    </head>
    <body>
        <h1>Disable Student!</h1><hr>
        <%
        ...
        <%
                    ...
                    int i = stmt.executeUpdate("Update SPMStudentMaster Set Status='J' Where SPMStudentMaster.RegisterNo='" + studentCode + "';");
