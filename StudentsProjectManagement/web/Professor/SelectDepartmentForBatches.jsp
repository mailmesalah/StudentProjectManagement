<%-- 
    Document   : SelectDepartmentForBatches
...
<html>
    <head>
        ...
        <title>Select Department For Batches</title>
    </head>
    <body bgcolor="#F0F0F0"><center>
        <h1>Select Department For Batches!</h1><hr>
        ...
        <%
                    ...
                    while(rs.next()) {
                %>
                <a href="ManageBatches.jsp?DepartmentCode=<%=rs.getInt("DeptCode")%>"><%=rs.getString("DeptName")%></a><br>
        <%
                    } 
                    rs.close();
                    stmt.close();
