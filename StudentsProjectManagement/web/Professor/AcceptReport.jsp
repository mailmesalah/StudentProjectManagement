<%-- 
    Document   : AcceptReport
    Created on : May 21, 2011, 8:06:17 AM
    Author     : Salah
--%>
...
<html>
    <head>
        ...
        <title>Accept Report</title>
    </head>
    <body>
        <h1>Accept Report !</h1><hr>
        <%
        ...
        <%
            ...
            try {
                ...
                int records = stmt.executeUpdate("Update SPMCurrentProject Set Status='RA' Where(GroupCode=" + groupCode + ");");
                if (records > 0) {
                    session.setAttribute("Info", "Successfully Accepted the Report !");
                    response.sendRedirect("ShowProject.jsp?batchcode=" + batchCode + "&batchname=" + batchName + "&deptcode=" + deptCode + "&groupcode=" + groupCode + "&groupname=" + groupName);
                } else {
