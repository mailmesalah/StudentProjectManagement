<%-- 
    Document   : RemoveCompletedProject
    Created on : May 21, 2011, 3:26:21 PM
    Author     : Salah
--%>
...
<html>
    <head>
        ...
        <title>Remove Completed Project</title>
    </head>
    <body>
        <h1>Remove Completed Project !</h1><hr>
        <%
        ...
        <%
            ...
            try{
                ...
                int records = stmt.executeUpdate("Delete From SPMProjectsCompleted Where (StudentCode="+studentID+" And ProjectCode="+projectCode+");");
                if(records>0){
