<%-- 
    Document   : AbstractRejected
    Created on : May 21, 2011, 8:04:33 AM
    Author     : Salah
--%>
...
<html>
    <head>
        ...
        <title>Abstract Rejected</title>
    </head>
    <body>
        <h1>Abstract Rejected !</h1><hr>
        <%
        ...
        <%
            ...
            try {
                ...
                int records = stmt.executeUpdate("Update SPMCurrentProject Set Status='AR' Where(GroupCode=" + groupCode + ");");
                if (records > 0) {
                    session.setAttribute("Info", "Successfully Rejected the Abstract !");
                    response.sendRedirect("ShowProject.jsp?batchcode=" + batchCode + "&batchname=" + batchName + "&deptcode=" + deptCode + "&groupcode=" + groupCode + "&groupname=" + groupName);
                } else {
